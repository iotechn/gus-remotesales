...
public class WXBizMsgCrypt {
	...
	String encrypt(String randomStr, String text) throws AesException {
		WxByteGroup byteCollector = new WxByteGroup();
		...
		byte[] padBytes = WxPKCS7Encoder.encode(byteCollector.size());
...
//		// 密钥，公众账号的app secret
//		// 提取密文
//		Map<String, String> encrypt = JacksonXmlUtil.parseObject(postData, new TypeReference<Map<String, String>>() {
//		});
//
//		// 验证安全签名
//		String signature = this.getSHA1(token, timeStamp, nonce, encrypt.get("Encrypt"));
//
//		// 和URL中的签名比较是否相等
...
//
//		// 解密
//        return decrypt(encrypt.get("Encrypt"));
//	}


	private String getSHA1(String token, String timestamp, String nonce, String encrypt) throws AesException {
